 ...
 * Test: testObjCompare()
 */
function testObjectCompareFunction() {
  var person1 = {
    'name': 'Ram',
    'age': 27,
    'vehicles': {
  ...
  var person2 = {
    ...
    'children': ['Ram', 'Ajay', 'Riya'],
    'age': 27
  };

  // Call the function to test
  var generatedOutput = IntentsUi.objectCompare(person1, person2);
  var expectedOutput = false;

  // Checking if generated output is same as expected output
  assertEquals(expectedOutput, generatedOutput, 'objectCompare');
}
...
function objectCompare(obj1, obj2) {
  ...
  /** 
   * Removing this check as results returned by gcp may change
   * So check only for properties of expectedOutput leaving any extra properties
   */
