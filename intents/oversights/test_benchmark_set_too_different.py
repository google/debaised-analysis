...
def test_1():
    ...
    expected_result = """[{'suggestion': 'A looks different from everyone else on avg_hour_of_work. You might also want to look  at lines_of_code since A also looks different on this.', 'oversight_name': 'Benchmark set too different', 'is_row_level_suggestion': True, 'row_list': [0, 1]}]"""
...
def test_2():
    ...
    expected_result = """[{'suggestion': 'A looks different from everyone else on current_year_revenue. You might also want to look  at last_year_revenue since A also looks different on this.', 'oversight_name': 'Benchmark set too different', 'is_row_level_suggestion': True, 'row_list': [0, 1, 2, 3, 6, 7]}]"""
...
def test_3():
    ...
    expected_result = """[{'suggestion': 'A looks different from everyone else on current_year_revenue. You might also want to look  at last_year_revenue since A also looks different on this.', 'oversight_name': 'Benchmark set too different', 'is_row_level_suggestion': True, 'row_list': [0, 1]}]"""
