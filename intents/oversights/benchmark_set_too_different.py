...
def benchmark_set_too_different(table, metric, all_metric, slice_compare_column, 
    ...
    for column_i in range(dimensions_len + 2, num_columns):
        ...
        if len(column_i_suggestion_list) > 0:
            ...
            suggestion_i = {}
            suggestion_i['suggestion'] = slice1 + ' looks different from everyone else on ' + metric + '. You might also want to look  at ' + columns_order[column_i] +' since ' + slice1 + ' also looks different on this.'
