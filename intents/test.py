...
# the structure of this file needs to be improved
...
from Utilities.enumerations import *
...
# print(table)
table = pandas.read_csv('databases/matches.csv')

query_result = trend.trend(table, 'win_by_runs', Granularities.annually, SummaryOperators.maximum, date_range=('2008-05-08', '2010-04-12'),  date_column_name='date', date_format='%Y-%m-%d')
...
query_result = top_k.top_k(table, 'win_by_runs', ['city'], False, 40, slices={'season' : 2017}, date_range=('2008-05-08', '2017-04-12'), date_column_name='date', date_format='%Y-%m-%d')
...
query_result = top_k.top_k(table, 'win_by_runs', ['player_of_match'], False, 5, slices={'season' : 2017}, date_range=('2017-05-09', '2017-05-12'), date_column_name='date', date_format='%Y-%m-%d', summary_operator=SummaryOperators.mean) 
...
query_result = top_k.top_k(table, 'Department_ID', ['Creation'], False, 1, slices=None, date_range=None, date_column_name='date', date_format='%Y-%m-%d', summary_operator=SummaryOperators.count) 
...
query_result = top_k.top_k(table, 'Year', ['Theme'], True, 10000, slices=None, date_range=None, date_column_name='date', date_format='%Y-%m-%d', group_columns=None, summary_operator=None) 
...
query_result = top_k.top_k(table, 'lat', ['city'], False, 10000, slices=None, date_range=None, date_column_name='date', date_format='%Y-%m-%d', summary_operator=SummaryOperators.maximum) 
...
query_result = top_k.top_k(table, 'Price', ['Publication_Date'], False, 10000, slices=None, date_range=None, date_column_name='date', date_format='%Y-%m-%d') 
...
query_result = top_k.top_k(table, 'salary', ['name'], True, 10000, slices=None, date_range=None, date_column_name='date', date_format='%Y-%m-%d') 
